...
import { 
  ...
  Settings, ChevronDown, Plus, LogOut, ShieldAlert, Sparkles 
} from 'lucide-react';
...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { name: 'Digital Cashbook', path: '/dashboard/cashbook', icon: BookOpen },
    { name: 'Customer Ledgers', path: '/dashboard/customers', icon: Users },
    ...
    <aside style={{
      ...
      <div>
        ...
        <div style={{ marginTop: '2rem', paddingTop: '1.5rem', borderTop: '1px solid rgba(255, 255, 255, 0.08)' }}>
          ...
          >
            <Sparkles size={18} color="#34d399" /> Features Showcase
          </Link>
          <Link
            href="/pricing"
            style={{
          ...
          >
            <Settings size={18} color="#c084fc" /> Pricing & Plans
          </Link>
        </div>
      </div>
      ...
      <div style={{
        ...
        <Link href="/" title="Back to Public Site" style={{ color: '#ef4444', textDecoration: 'none' }}>
          <LogOut size={18} />
        </Link>
      </div>
    </aside>
