  ...
  return (
    <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '3rem 1.5rem' }}>
      <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
        <Badge variant="purple" style={{ marginBottom: '1rem' }}>Day 13 • Auth & 3 Core Modules</Badge>
        ...
        <p style={{ color: '#94a3b8', fontSize: '1.1rem', maxWidth: '650px', margin: '0 auto' }}>
          Explore our 3 core CRUD modules, auth-protected dashboard, and Forgot Password UI workflow.
        </p>
      </div>
