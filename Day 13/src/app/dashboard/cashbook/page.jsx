...
import { 
  BookOpen, Plus, ArrowDownLeft, ArrowUpRight, Trash2, Edit, Search 
} from 'lucide-react';
    ...
    <div className="animate-fade-in">
      ...
      <Modal isOpen={!!editModalTx} onClose={() => setEditModalTx(null)} title="✏️ Edit Cashbook Transaction">
        <form onSubmit={handleUpdateTransaction}>
          <Input label="Amount (PKR)" type="number" value={editAmount} onChange={(e) => setEditAmount(e.target.value)} error={editErrors.amount} required />
          <Input label="Description" value={editNote} onChange={(e) => setEditNote(e.target.value)} />
