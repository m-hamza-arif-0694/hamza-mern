...
export default function Sidebar() {
  ...
  const { user, activeBranch, setActiveBranch, logout } = useAuth();
  ...
  return (
    <aside className="sidebar-aside" style={{
      ...
      <div>
        {/* ACTIVE BUSINESS BRANCH SELECTOR BOX */}
        <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: '0.72rem', color: '#34d399', fontWeight: 600 }}>● Authenticated Session</div>
        </div>
        <button
          onClick={logout}
          title="Sign Out"
