  ...
  return (
    <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '3rem 1.5rem' }}>
      <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
        <Badge variant="blue" style={{ marginBottom: '1rem' }}>Cross-Platform Access</Badge>
        <h1 style={{ fontSize: 'clamp(2.2rem, 4vw, 3.5rem)', fontWeight: 800, color: 'white', marginBottom: '1rem' }}>
          Download HisabDo App
        </h1>
        <p style={{ color: '#94a3b8', fontSize: '1.1rem', maxWidth: '600px', margin: '0 auto' }}>
          Access your digital cashbook, Udhar ledgers, and multi-business branches from any device.
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
        ...
        <Card style={{ textAlign: 'center' }}>
          ...
          <Link href="/login" style={{ textDecoration: 'none' }}>
            <Button variant="primary" style={{ width: '100%' }}>Launch Web App Portal →</Button>
          </Link>
        </Card>
      </div>
    </div>
