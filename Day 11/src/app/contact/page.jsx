  ...
  return (
    <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '3rem 1.5rem' }}>
      <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
        <Badge variant="purple" style={{ marginBottom: '1rem' }}>Support & Feedback</Badge>
        ...
        <p style={{ color: '#94a3b8', fontSize: '1.1rem', maxWidth: '600px', margin: '0 auto' }}>
          Need assistance or custom branch onboarding? Send us a validated inquiry.
        </p>
      </div>

      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: '3rem', flexWrap: 'wrap' }}>
        <Card>
          <h2 style={{ fontSize: '1.4rem', fontWeight: 800, color: 'white', marginBottom: '1.5rem' }}>Direct Channels</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <div>
                <div style={{ fontSize: '0.85rem', color: '#94a3b8' }}>WhatsApp / Phone</div>
        ...
        <Card>
          {submitted ? (
            ...
            <form onSubmit={handleSubmit}>
              <h2 style={{ fontSize: '1.4rem', fontWeight: 800, color: 'white', marginBottom: '1.5rem' }}>Validated Contact Form</h2>
