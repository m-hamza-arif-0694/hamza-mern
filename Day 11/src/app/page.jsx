...
export default function HomePage() {
  const [demoCash, setDemoCash] = useState([
    { id: 1, type: 'in', amount: 18000, note: 'Morning Counter Sale' },
    { id: 2, type: 'out', amount: 4200, note: 'K-Electric Bill Payment' }
  ]);
    ...
    <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '2rem 1.5rem' }}>
      <section style={{ textAlign: 'center', padding: '4rem 0 3rem' }}>
        <div style={{ marginBottom: '1.5rem' }}>
          <Badge variant="blue" style={{ padding: '0.4rem 1.25rem', fontSize: '0.85rem' }}>
            <Zap size={15} style={{ display: 'inline', marginRight: '0.4rem' }} /> Day 11 Full CRUD Architecture
          </Badge>
        </div>
        ...
        <h1 style={{
          ...
          Complete Digital Bookkeeping <br />
          Built for Pakistan's Retailers
        </h1>

        <p style={{ fontSize: '1.2rem', color: '#94a3b8', maxWidth: '750px', margin: '0 auto 2.5rem', lineHeight: 1.6 }}>
          Manage your shop's transactions with full CRUD capabilities (Create, Read, Edit, Delete), Pakistani phone validation, Loading/Empty/Error state handling, and automated WhatsApp dues reminders.
        </p>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap' }}>
          ...
          <Link href="/features" style={{ textDecoration: 'none' }}>
            <Button variant="secondary" size="lg">Explore CRUD Modules</Button>
          </Link>
        </div>
      </section>
      ...
      <section style={{ margin: '4rem 0' }}>
        <Card style={{ border: '1px solid rgba(59, 130, 246, 0.4)' }}>
          <CardHeader
            title="Interactive Digital Cashbook CRUD Demo"
            subtitle="Try the live component with real-time form validation & running balances"
            action={
