...
export function EmptyState({ title = 'No Data Available', message = 'No records found matching your query.', actionText, onAction }) {
  return (
    <div style={{
...
export function ErrorState({ title = 'Action Required', message, onDismiss }) {
